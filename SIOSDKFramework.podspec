#
#  Be sure to run `pod spec lint SIOSDKFramework.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "SIO-LR"
  # spec.authors            = { "SIO-LR" => "edi@lendrise.com" }
  # spec.social_media_url   = "https://twitter.com/SIO-LR"
  ...
  spec.vendored_frameworks = 'Frameworks/SIOSDKFramework.xcframework'
